...
class MyFrame(wx.Frame):
    def __init__(self):
        ...
        wx.StaticText(panel, -1, u"base64编码输入输出:", pos = (8, 604))
        wx.StaticText(panel, -1, u"base64解码结果显示:", pos = (8, 634))
        self.Base64Encode = wx.TextCtrl(panel, 15, "", pos = (150, 602),size=(560,20))
        self.Base64Decode = wx.TextCtrl(panel, 15, "", pos = (150, 632),size=(560,20))
        self.buttonCheck7 = wx.Button(parent=panel, label=u"base64加密", pos = (730,595))
        self.Bind(wx.EVT_BUTTON, self.Base64En, self.buttonCheck7)
        self.buttonCheck8 = wx.Button(parent=panel, label=u"base64解密", pos = (730,625))
        self.Bind(wx.EVT_BUTTON, self.Base64De, self.buttonCheck8)
    ...
    def Base64En(self,event):
        src = str(self.inputN.GetValue().encode('utf8'))
        rst = base64.b64encode(src)
        self.Base64Encode.SetValue(rst.decode('utf8'))

    def Base64De(self,event):
        src = str(self.Base64Encode.GetValue().encode('utf8'))
        rst = base64.b64decode(src)
        self.Base64Decode.SetValue(rst.decode('utf8'))
